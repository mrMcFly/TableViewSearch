...
static NSString *firstNames[] = {
    ...
    @"Jackson", @"Aiden",     @"Aiden",     @"Liam",     @"Lucas",
    @"Noah",    @"Mason",     @"Jayden",    @"Ethan",    @"Jacob",
    @"Jack",    @"Caden",     @"Logan",     @"Benjamin", @"Michael",
    @"Caleb",   @"Ryan",      @"Alexander", @"Elijah",   @"James",
    @"William", @"Oliver",    @"Connor",    @"Matthew",  @"Daniel",
    @"Luke",    @"Brayden",   @"Jayce",     @"Henry",    @"Carter",
    @"Dylan",   @"Gabriel",   @"Joshua",    @"Nicholas", @"Isaac",
    @"Owen",    @"Nathan",    @"Grayson",   @"Eli",      @"Landon",
    @"Andrew",  @"Max",       @"Samuel",    @"Gavin",    @"Wyatt",
    @"Christian",@"Hunter",   @"Cameron",   @"Evan",     @"Charlie",
    @"David",   @"Sebastian", @"Joseph",    @"Dominic",  @"Anthony",
    @"Colton",  @"John",      @"Tyler",     @"Zachary",  @"Thomas",
    @"Julian",  @"Levi",      @"Adam",      @"Isaiah",   @"Alex",
    @"Aaron",   @"Parker",    @"Cooper",    @"Miles",    @"Chase",
    @"Muhammad",@"Christopher",@"Blake",    @"Austin",   @"Jordan",
    @"Leo",     @"Jonathan",  @"Adrian",    @"Colin",    @"Hudson",
    @"Ian",     @"Xavier",    @"Camden",    @"Tristan",  @"Carson",
    @"Jason",   @"Nolan",     @"Riley",     @"Lincoln",  @"Brody",
    @"Bentley", @"Nathaniel", @"Josiah",    @"Declan",   @"Jake",
    @"Asher",   @"Jeremiah",  @"Cole",      @"Mateo",    @"Micah",
};
...
static NSString *lastNames[] = {
    ...
    @"Stewart",  @"Sanchez",  @"Morris",   @"Rogers",   @"Bailey",
